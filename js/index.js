window.onload = function({onComplete:galleryLoad}){
  ...
  new TimelineMax()
    ...
    .from('#flare2',      1.0, {x:119, y:115, scale:0, ease:Power0.easeNone}, 1)
    .to('#flare1',        2.0, {scale:0.5, rotationX:25, ease:Power1.easeIn}, 2)
    .to('#flare1',        2.0, {x:4, y:2, ease:Power0.easeNone}, 1.9)
    .to('#flare1',        1.0, {alpha:1, ease:Power1.easeInOut}, 1.9)
    .to('#flare1',        0.8, {alpha:3, ease:Power3.easeIn}, 2.7)
    .from('#logoChrome',  1.5, {alpha:0, ease:Power3.easeInOut}, 0)
    .fromTo('#logoDark',  4.0, {y:-1, alpha:1}, {y:3, alpha:0.8, ease:Power1.easeInOut}, 2)
